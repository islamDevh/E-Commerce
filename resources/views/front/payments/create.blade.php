...
@section('content')
<!--main area-->
<main id="main" class="main-site left-sidebar" style="padding-top: 0;">
    <div class="container">
...
<script>
    ...
    // Initialize the payment form and check the payment status
    initialize();
