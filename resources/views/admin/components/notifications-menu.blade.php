<div class="dropdown nav-item main-header-notification">
    ...
    <div class="dropdown-menu">
        ...
        <a href="{{ $notification->data['url'] }}?notification_id={{$notification->id}}" class="d-flex p-3 border-bottom">
                <div class="notifyimg bg-success">
                    <i class="la la-shopping-basket text-white"></i>
                </div>
                <div class="mr-3">
                    <h5 @if(!$notification->unread()) class="notification-label mb-1" @endif>New Order Received</h5>
